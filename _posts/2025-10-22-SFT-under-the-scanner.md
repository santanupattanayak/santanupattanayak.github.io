...
| **Attribute** | **Pretraining**                                                                                                                                                          | **Supervised Fine-Tuning (SFT)** | **Alignment (RLHF)** |
|----------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|-----------------------|
...
| **Optimization Method** | Gradient descent on the next token prediction modeling objective                                                                                                         | Supervised gradient descent minimizing imitation loss. | Policy-gradient optimization (e.g., PPO or related methods) with reward shaping and KL regularization. |
